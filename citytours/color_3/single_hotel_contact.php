...
<![endif]-->
                        ...
                        <ul id="top_links">
                            <li>
                                <div class="dropdown dropdown-access">
                                    <a href="single_hotel_contact.php#" class="dropdown-toggle" data-toggle="dropdown" id="access_link">Sign in</a>
                                    <div class="dropdown-menu">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <a href="single_hotel_contact.php#" class="bt_facebook">
                                                    <i class="icon-facebook"></i>Facebook </a>
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <a href="single_hotel_contact.php#" class="bt_paypal">
                                        ...
                                        <a id="forgot_pw" href="single_hotel_contact.php#">Forgot password?</a>
                                ...
                                <div class="menu-wrapper">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="single_hotel_contact.php#0"><i class="icon-circle color_3"></i> Color version 3</a></li>
                    ...
                    <ul id="top_tools">
                        <li>
                            <div class="dropdown dropdown-search">
                                <a href="single_hotel_contact.php#" class="search-overlay-menu-btn" data-toggle="dropdown"><i class="icon-search"></i></a>
                            </div>
                        </li>
                        <li>
                            <div class="dropdown dropdown-cart">
                                <a href="single_hotel_contact.php#" class="dropdown-toggle" data-toggle="dropdown"><i class=" icon-basket-1"></i>Cart (0) </a>
                                <ul class="dropdown-menu" id="cart_items">
                                    <li>
                                        <div class="image"><img src="img/thumb_cart_1.jpg" alt="image"></div>
                                        <strong>
										<a href="single_hotel_contact.php#">Louvre museum</a>1x $36.00 </strong>
                                        <a href="single_hotel_contact.php#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
                                        <div class="image"><img src="img/thumb_cart_2.jpg" alt="image"></div>
                                        <strong>
										<a href="single_hotel_contact.php#">Versailles tour</a>2x $36.00 </strong>
                                        <a href="single_hotel_contact.php#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
                                        <div class="image"><img src="img/thumb_cart_3.jpg" alt="image"></div>
                                        <strong>
										<a href="single_hotel_contact.php#">Versailles tour</a>1x $36.00 </strong>
                                        <a href="single_hotel_contact.php#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
    ...
    <div class="row">
        <div class="col-md-8" id="single_tour_desc">
            ...
            <p class="visible-sm visible-xs"><a class="btn_map" data-toggle="collapse" href="single_hotel_contact.php#collapseMap" aria-expanded="false" aria-controls="collapseMap" data-text-swap="Hide map" data-text-original="View on map">View on map</a></p><!-- Map button for tablets/mobiles -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-3">
                    ...
                    <a href="../../cdn-cgi/l/email-protection#7a121f160a3a19130e030e150f080954191517" id="email_footer"><span class="__cf_email__" data-cfemail="dab2bfb6aa9ab9b3aea3aeb5afa8a9f4b9b5b7">[email&#160;protected]</span></a>
                </div>
                ...
                <div class="col-md-12">
                    <div id="social_footer">
                        <ul>
                            ...
                            <li><a href="single_hotel_contact.php#"><i class="icon-linkedin"></i></a></li>
                        </ul>
                        <p>© Citytours 2015</p>
                    </div>
                </div>
