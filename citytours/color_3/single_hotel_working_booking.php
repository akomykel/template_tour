                                ...
                                <div class="menu-wrapper">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="single_hotel_working_booking.php#0"><i class="icon-circle color_3"></i> Color version 3</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-3">
                    ...
                    <a href="../../cdn-cgi/l/email-protection#cca4a9a0bc8cafa5b8b5b8a3b9bebfe2afa3a1" id="email_footer"><span class="__cf_email__" data-cfemail="254d40495565464c515c514a5057560b464a48">[email&#160;protected]</span></a>
                </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="post" action="http://www.ansonika.com/citytours/color_3/assets/review_hotel.php" name="review_hotel" id="review_hotel">
