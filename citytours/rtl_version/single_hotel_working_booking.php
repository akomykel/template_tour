                                        ...
                                        <h3>Pages</h3>
                                         <ul>
                                           ...
                                           <li><a href="general_page.html">General page</a></li>
                                            ...
                                            <li><a href="../index.html">LTR version</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-4">
                                        <h3>Pages</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-3">
                    ...
                    <a href="../../cdn-cgi/l/email-protection#046c61687444676d707d706b7176772a676b69" id="email_footer"><span class="__cf_email__" data-cfemail="6d0508011d2d0e0419141902181f1e430e0200">[email&#160;protected]</span></a>
                </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="post" action="http://www.ansonika.com/citytours/rtl_version/assets/review_hotel.php" name="review_hotel" id="review_hotel">
