                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="../color_3/index.html"><i class="icon-circle color_3"></i> Color version 3</a></li>
                                           	<li><a href="single_hotel_working_booking.php#0"><i class="icon-circle color_4"></i> Color version 4</a></li>
                                        </ul>
                                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-3">
                    ...
                    <a href="../../cdn-cgi/l/email-protection#d5bdb0b9a595b6bca1aca1baa0a7a6fbb6bab8" id="email_footer"><span class="__cf_email__" data-cfemail="f8909d9488b89b918c818c978d8a8bd69b9795">[email&#160;protected]</span></a>
                </div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="post" action="http://www.ansonika.com/citytours/color_4/assets/review_hotel.php" name="review_hotel" id="review_hotel">
